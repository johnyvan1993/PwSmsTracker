 ...
 */
package com.library.pwsmstracker.smstracker;
...
class SmsObserver extends ContentObserver {
    ...
    SmsObserver(ContentResolver contentResolver, Handler handler, SmsCursorParser smsCursorParser, SmsListener smsListener) {
        super(handler);
